...
namespace ProjetoFinal.Controllers
{
    public class PedidoController : Controller
    {
        ...
        {
            var myDbContext = _context.pedido.Include(p => p.consumidor);
        ...
        public async Task<IActionResult> Create([Bind("id,consumidorId")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,consumidorId")] Pedido pedido)
        {
            if (id != pedido.id)
            {
                return NotFound();
